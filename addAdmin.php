...
<!-- For Admin -->
	...
	<body style="background-color:#FFF9E7;">
		...
		<div class="shape">	
			...
			<input type="submit" name="save" value="Save" class="btn2">
...
if (isset($_POST['save'])){
	...
	$result = $mysqli->query("INSERT INTO tb_login (firstName, lastName, user, password) VALUES('$fn', '$ln','$us', '$pw')") or die($mysqli->error);
