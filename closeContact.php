...
if(isset($_POST['searchBtn']))
{
  ...
  $query = "SELECT * FROM tb_ctsreport LEFT JOIN tb_usersreg ON tb_ctsreport.idNum=tb_usersreg.idNum WHERE CONCAT(tb_ctsreport.idNum, time, date, lastName, firstName, status, contactNum, street, barangay, city) LIKE '%".$searchBox."%'";
...
elseif(isset($_POST['filterBtn']))
{
  ...
  WHERE status='Positive' OR status='Self-isolated'";
  $searchResult = filterTable($query);
}
...
<link rel="stylesheet" href="style.css">
    ...
    <style>
		...
		.sidebar li a.contactsTab{
		  background:  #FFF9E7;
		  width: 110%;
		}
		.sidebar i[class='bx bx-folder']{
		  color: #33A9AB;
		}
		.sidebar li a #contactsLink{
		  color:#33A9AB;
		}
		.sidebar.open ul li a.contactsTab::before{
		  content: '';
		  position:absolute;
		  top:-50px;
		  left:186px;
		...
		.sidebar.open ul li a.contactsTab::after{
		  content: '';
		  position:absolute;
		  bottom:-50px;
		  left:186px;
...
<!--  TABS --!>
  ...
  <div class="sidebar">
    ...
    <ul class="nav-list">
     ...
     <li>
       <a href="closeContact.php" class="contactsTab">
         <i class='bx bx-folder' ></i>
         <span class="links_name" id="contactsLink">Close Contacts</span>
       </a>
	        ...
	        <div class='col-sm-3'>
	        	<form method="POST" autocomplete="off">
		            ...
		            <div class="refreshBtn">
			            <img src="images/refresh_hover.png" class="refreshBtn_hover" onclick="location.href='closeContact.php';"> 
   ...
   if(sidebar.classList.contains("open")){
    ...
    <table class="table">
        ...
        <tr  id="trow">
        	...
        	<td class="tdata"><?php echo $row['contactNum'];?></td>
        	<td class="tdata"><?php echo $row['street'].", ".$row['barangay'].", ".$row['city']?></td>
