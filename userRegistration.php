...
<div class="container form-group">
		...
		<div class="row justify-content-center">
				...
				<div class="col-md-4 ">
					<input type="submit" name="save" value="Save"  class="btn btn-primary " style="width:105px; vertical-align: middle;">
					<input type="reset" name="clear" value="Reset" class="btn btn-primary offset-1" onclick="resetImage()" style="width:105px; vertical-align: middle;">
				</div>
...
if (isset($_POST['save'])){
	...
	$result = $mysqli->query("INSERT INTO tb_usersreg (firstName, lastName, email, password, gender, image_path, contactNum, street, barangay, city) VALUES('$fn', '$ln','$em', '$pw', '$gen', '$im', '$cn', '$st', '$brgy', '$ct')") or die($mysqli->error);
